...
from .config import SansIcsSuspiciousDomainsConfig


class SansIcsSuspiciousDomainsAdapter:
    name = "sans_ics_suspicious_domains"

    def __init__(self) -> None:
        cfg = SansIcsSuspiciousDomainsConfig()
