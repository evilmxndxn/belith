...
from .config import HaveibeenpwnedKAnonymityConfig


class HaveibeenpwnedKAnonymityAdapter:
    name = "haveibeenpwned_k_anonymity"

    def __init__(self) -> None:
        cfg = HaveibeenpwnedKAnonymityConfig()
